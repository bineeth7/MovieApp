...
<!-- <div class="movie-cast border-b border-cyan-400">
    <div class="movie-images">
        <div class="container mx-auto px-4 py-10">
            <div class="h2 text-4xl font-semibold text-cyan-400">Images</div>
            <div class="grid grid-col-1 sm:grid-col-2 md:grid-col-3 gap-8">
                @foreach ($movie['images']['backdrop'] as $image)
                    @if ($loop->index <8)
                      <div class="mt-8">
                        <a href="">
